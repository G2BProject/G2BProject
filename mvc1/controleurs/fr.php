...
// sign up
	...
	$TXT_MEMBRE = 'Membre';
	$TXT_ARTISTE = 'Artiste';
	$TXT_PROPRIETAIRE = 'Propriétaire de salle';
	$TXT_NOM_UTILISATEUR = 'Nom d\'utilisateur';
	...
	$TXT_NEWS = 'Voulez-vous vous inscrire à la newsletter?';
	$OUI = 'Oui';
	$NON = 'Non';
	$TXT_CGU = 'J\'ai lu et j\'accepte les conditions générales d\'utilisation du site';
