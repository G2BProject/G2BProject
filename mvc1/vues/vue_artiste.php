	...
	<div class="container6">
		<div id="photo">
			...
			<ul>
				...
				<li class="caract"><div class="txt2"href="#"><a class="styleartiste">Style </a>:   Type de musique jouée, caractéristiques musicales de l'artiste</div></li>
				<li class="caract"><div class="txt2"href="#"><a class="styleartiste">A venir </a>:   Date du prochain évènement impliquant l'artiste avec éventuellement le lien y renvoyant</div></li>
				<li class="caract"><div class="txt2"href="#"><a class="styleartiste">   Dernière production </a>:    Nom et date de la dernière production de l'artiste</div></li>
				<li class="caract"><div class="txt2"href="#"><a class="styleartiste">   Nombre de fans</a>:    XXX</div></li>
			</ul>
