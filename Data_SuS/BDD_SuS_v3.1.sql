...
--
-- Client :  localhost
-- Généré le :  Jeu 15 Mai 2014 à 10:37
...
INSERT INTO `membre` (`ID`, `pseudo`, `name`, `prenom`, `adresse_email`, `mot_de_passe`, `date_de_naissance`, `adresse`, `sexe`, `bio`, `date_inscription`, `nombre_de_message`, `etat_connexion`, `Role_ID`, `etat_compte`, `cle_validation`) VALUES
