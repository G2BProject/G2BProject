...
<nav>
	<table class= "tableforum">
			...
			<tbody>
				<tr>
					<td class="cellule"> <a href= "#" style="text-decoration:none"><div class="rubrique1"> <?php $reponse = $bdd->query('SELECT sous_categorie_forum  FROM sous_categorie_forum WHERE categorie_forum_ID =4 ORDER BY ID DESC limit 1 ');
