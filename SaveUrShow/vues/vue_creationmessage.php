...
<form action="index.php?page=messageforum&post=<?php echo $post ?>" method="post" >
	<?php 
			if (!isset($_SESSION['pseudo'])){
				echo '
				<ul><li><a href="?page=connexion"class="boutonforum"  style="text-decoration:none">Connexion</a></li>
				<li><a href="?page=inscription" class="boutonforum"  style="text-decoration:none">Inscription</a></li></ul>';
