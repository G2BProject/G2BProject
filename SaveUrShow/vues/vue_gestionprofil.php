<a class="standard" href="#">Modifier mon profil</a><br></br>
...
<form method="post" action="index.php?page=gestion_profil&profil=<?php echo $_GET['profil'] ?>">
...
<p><label class="txtconcerts_gestion_profil">Modifier l'adresse: </label><input class="input" type="text" name="adresse"/></p>
</div>

<div class="container2gestionprofil">
<p><label class="txtartistes_gestion_profil">Modifier le mail:</label><input class="input" type="text" name="adresse_mail"/></p>
</div>
 <div class="container2gestionprofil">
<p><label class="txtgenre_gestion_profil">Modifier votre Biographie</label><textarea name="bio" rows ="3" cols="30" id="bio"></textarea> </p>
</div>
<!-- <div class="container2gestionprofil">
